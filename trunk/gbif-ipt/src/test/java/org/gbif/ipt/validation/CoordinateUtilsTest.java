...
public class CoordinateUtilsTest {
  ...
  public static Collection<Object[]> getTestParameters() {
    ...
    list.add(new Object[] {"10°3'0''S", -10.05, CoordinateUtils.LATITUDE});
    list.add(new Object[] {"10°3'0''N", 10.05, CoordinateUtils.LATITUDE});
    list.add(new Object[] {"0°0'0''N", 0.0, CoordinateUtils.LATITUDE});
    list.add(new Object[] {"1°0'0''N", 1.0, CoordinateUtils.LATITUDE});
    list.add(new Object[] {"176°11'60''N", 176.20, CoordinateUtils.LATITUDE});
    list.add(new Object[] {"0°58'48''N", .98, CoordinateUtils.LATITUDE});
    // LONGITUDE test
    list.add(new Object[] {"10°3'0''W", -10.05, CoordinateUtils.LONGITUDE});
    list.add(new Object[] {"10°3'0''E", 10.05, CoordinateUtils.LONGITUDE});
    list.add(new Object[] {"176°11'60''E", 176.20, CoordinateUtils.LONGITUDE});
    list.add(new Object[] {"0°0'0''E", 0.0, CoordinateUtils.LONGITUDE});
    list.add(new Object[] {"1°0'0''E", 1.0, CoordinateUtils.LONGITUDE});
    list.add(new Object[] {"0°58'48''E", .98, CoordinateUtils.LONGITUDE});
