 ...
 * source when stable, as this is an EML Model Factory based on the Apache
 * Commons Digester and will be used when importing DwC-A
 * 
...
public class EmlFactory {
   ...
   * 
   * Note the following: - Metadata provider rules are omitted on the assumption
   * that the provider is the same as the creator - Contact rules are omitted on
   * the assumption that contacts are covered by the creator and associated
   * parties - Publisher rules are omitted on the assumption the publisher is
   * covered by the creator and associated parties
   * 
  ...
  public static Eml build(InputStream xml) throws IOException, SAXException {
    ...
    digester.addBeanPropertySetter("eml/dataset/additionalInfo/para",
        "additionalInfo");
    digester.addBeanPropertySetter("eml/dataset/intellectualRights/para",
        "intellectualRights");
    digester.addBeanPropertySetter("eml/dataset/distribution/online/url",
        "distributionUrl");
    digester.addBeanPropertySetter("eml/dataset/purpose/para", "purpose");
    digester.addBeanPropertySetter("eml/additionalMetadata/metadata/citation",
        "citation");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/specimenPreservationMethod",
        "specimenPreservationMethod");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/resourceLogoUrl", "logoUrl");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/metadataLanguage", "metadataLanguage");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/hierarchyLevel", "hierarchyLevel");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/collection/parentCollectionIdentifier",
        "parentCollectionId");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/collection/collectionIdentifier",
        "collectionId");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/collection/collectionName",
        "collectionName");
    ...
    addAgentRules(digester, "eml/dataset/metadataProvider",
        "setMetadataProvider");
  ...
  /**
   * This is a reusable set of rules to build Agents and their Addresses, and
   * add the Agent to the predecessor object on the Stack Note that we are
   * ignoring the userId as there have been no requests for the IPT to support
   * this
   * 
   * @param digester to add the rules to
   * @param prefix The XPath prefix to prepend for extracting the Agent
   *          information
   * @param parentMethod Of the previous stack object to call and add the Agent
   *          to
   */
  private static void addAgentRules(Digester digester, String prefix,
      String parentMethod) {
    digester.addObjectCreate(prefix, Agent.class);
    digester.addBeanPropertySetter(prefix + "/individualName/givenName",
        "firstName");
    digester.addBeanPropertySetter(prefix + "/individualName/surName",
        "lastName");
    ...
    digester.addBeanPropertySetter(prefix + "/address/administrativeArea",
        "province");
  ...
  private static void addBibliographicCitations(Digester digester) {
    digester.addObjectCreate("eml/additionalMetadata/metadata/bibliography",
        BibliographicCitationSet.class);
    digester.addCallMethod(
        "eml/additionalMetadata/metadata/bibliography/citation", "add", 1);
    digester.addCallParam(
        "eml/additionalMetadata/metadata/bibliography/citation", 0);
    // add the BibliographicCitations to the list in EML
    digester.addSetNext("eml/additionalMetadata/metadata/bibliography",
        "setBibliographicCitationSet");
  }
  ...
  private static void addFormationPeriodRules(Digester digester) {
    digester.addObjectCreate("eml/additionalMetadata/metadata/formationPeriod",
        TemporalCoverage.class);
    digester.addCallMethod("eml/additionalMetadata/metadata/formationPeriod",
        "setFormationPeriod", 1);
    digester.addCallParam("eml/additionalMetadata/metadata/formationPeriod", 0);
    digester.addSetNext("eml/additionalMetadata/metadata/formationPeriod",
        "addTemporalCoverage"); // add the TemporalCoverage to the list in EML
  }
  ...
  private static void addGeographicCoverageRules(Digester digester) {
    digester.addObjectCreate("eml/dataset/coverage/geographicCoverage",
    ...
    digester.addSetNext(
        "eml/dataset/coverage/geographicCoverage/boundingCoordinates",
        "setBoundingCoordinates"); // add the BBox to the GeospatialCoverage
    digester.addSetNext("eml/dataset/coverage/geographicCoverage",
        "addGeospatialCoverage"); // add the GeospatialCoverage to the list in
                                  // EML
  }
  ...
  private static void addJGTICuratorialIUnit(Digester digester) {
    digester.addObjectCreate(
        "eml/additionalMetadata/metadata/jgtiCuratorialUnit",
        JGTICuratorialUnit.class);
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/jgtiCuratorialUnit/jgtiUnitType",
        "unitType");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/jgtiCuratorialUnit/jgtiUnitRange/beginRange",
        "rangeStart");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/jgtiCuratorialUnit/jgtiUnitRange/endRange",
        "rangeEnd");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/jgtiCuratorialUnit/jgtiUnits",
        "rangeStart");
    ...
    digester.addSetNext("eml/additionalMetadata/metadata/jgtiCuratorialUnit",
        "addJgtiCuratorialUnit"); // add the JGTICuratorialIUnit to the list in
                                  // EML
  ...
  private static void addKeywordRules(Digester digester) {
    ...
    digester.addBeanPropertySetter("eml/dataset/keywordSet/keywordThesaurus",
        "keywordThesaurus");
  ...
  private static void addLivingTimePeriodRules(Digester digester) {
    digester.addObjectCreate(
        "eml/additionalMetadata/metadata/livingTimePeriod",
        TemporalCoverage.class);
    digester.addCallMethod("eml/additionalMetadata/metadata/livingTimePeriod",
        "setLivingTimePeriod", 1);
    digester.addCallParam("eml/additionalMetadata/metadata/livingTimePeriod", 0);
    digester.addSetNext("eml/additionalMetadata/metadata/livingTimePeriod",
        "addTemporalCoverage"); // add the TemporalCoverage to the list in EML
  }

  /**
   * Adds rules to extract the methods In the EML, it will always be a
   * repetition of [methodStep, ?sampling, ?qualityControl] (sampling and
   * quality control are optional) to handle this, the utility object
   * MethodsParseUtil is used to collect the methods
   * 
   * @param digester to add the rules to
   */
  private static void addMethodRules(Digester digester) {
    digester.addObjectCreate("eml/dataset/methods", MethodParseUtil.class);
    digester.addCallMethod("eml/dataset/methods/methodStep/description/para",
        "collectStep", 1);
    ...
    digester.addCallMethod(
        ...
        "collectExtentDesc", 1);
    digester.addCallParam(
        "eml/dataset/methods/sampling/studyExtent/description", 0);
    digester.addCallMethod(
        "eml/dataset/methods/sampling/samplingDescription/para",
        "collectSamplingDesc", 1);
    digester.addCallParam(
        "eml/dataset/methods/sampling/samplingDescription/para", 0);
    digester.addCallMethod(
        "eml/dataset/methods/qualityControl/description/para",
        "collectQualityDesc", 1);
    digester.addCallParam(
        "eml/dataset/methods/qualityControl/description/para", 0);
    digester.addSetTop("eml/dataset/methods", "updateEml"); // note that this is
                                                            // pushing the EML
                                                            // onto the util and
                                                            // popping the util
  }
  ...
  private static void addPhysicalDataRules(Digester digester) {
    digester.addObjectCreate("eml/additionalMetadata/metadata/physical",
        PhysicalData.class);
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/physical/objectName", "name");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/physical/characterEncoding", "charset");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/physical/dataFormat/externallyDefinedFormat/formatName",
        "format");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/physical/dataFormat/externallyDefinedFormat/formatVersion",
        "formatVersion");
    digester.addBeanPropertySetter(
        "eml/additionalMetadata/metadata/physical/distribution/online/url",
        "distributionUrl");
    digester.addSetNext("eml/additionalMetadata/metadata/physical",
        "addPhysicalData"); // add the PhysicalData to the list in EML
  }
  ...
  private static void addProjectRules(Digester digester) {
    ...
    // "projectAbstract");
    digester.addBeanPropertySetter("eml/dataset/project/funding/para",
        "funding");
    addStudyAreaDescriptionRules(digester);
    digester.addBeanPropertySetter(
        "eml/dataset/project/designDescription/description",
        "designDescription");
  ...
  /**
   * Adds rules for the study area description: <studyAreaDescription>
   * <descriptor name="generic" citableClassificationSystem="false">
   * <descriptorValue>Turkish Mountains</descriptorValue> </descriptor>
   * </studyAreaDescription>
   * 
   * @param digester To add the rules to
   */
  private static void addStudyAreaDescriptionRules(Digester digester) {
    digester.addObjectCreate("eml/dataset/project/studyAreaDescription",
        StudyAreaDescription.class);

    // get the descriptor@name attribute and set it
    digester.addCallMethod(
        "eml/dataset/project/studyAreaDescription/descriptor", "setName", 1);
    digester.addCallParam(
        "eml/dataset/project/studyAreaDescription/descriptor", 0, "name");

    // get the descriptor@citableClassificationSystem and set it
    digester.addCallMethod(
        "eml/dataset/project/studyAreaDescription/descriptor",
        "setCitableClassificationSystem", 1);
    digester.addCallParam(
        "eml/dataset/project/studyAreaDescription/descriptor", 0,
    ...
    digester.addSetNext("eml/dataset/project/studyAreaDescription",
  ...
  private static void addTaxonomicCoverageRules(Digester digester) {
    digester.addObjectCreate("eml/dataset/coverage/taxonomicCoverage",
    ...
    digester.addSetNext(
        "eml/dataset/coverage/taxonomicCoverage/taxonomicClassification",
        "setTaxonKeyword"); // set the TaxonKeyword part of the
                            // TaxonomicCoverage
  ...
  private static void addTemporalCoverageRules(Digester digester) {
    digester.addObjectCreate("eml/dataset/coverage/temporalCoverage",
        TemporalCoverage.class);
    digester.addCallMethod(
        "eml/dataset/coverage/temporalCoverage/singleDateTime/calendarDate",
        "setStart", 2);
    digester.addCallParam(
        "eml/dataset/coverage/temporalCoverage/singleDateTime/calendarDate", 0);
    digester.addObjectParam(
        "eml/dataset/coverage/temporalCoverage/singleDateTime/calendarDate", 1,
        "yyyy-MM-dd");
    digester.addCallMethod(
        "eml/dataset/coverage/temporalCoverage/singleDateTime/calendarDate",
        "setEnd", 2);
    ...
    digester.addObjectParam(
        "eml/dataset/coverage/temporalCoverage/rangeOfDates/endDate/calendarDate",
        1, "yyyy-MM-dd");
    digester.addSetNext("eml/dataset/coverage/temporalCoverage",
        "addTemporalCoverage"); // add the TemporalCoverage to the list in EML
  }
