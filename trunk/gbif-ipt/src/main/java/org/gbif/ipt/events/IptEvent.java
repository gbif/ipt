...
/**
 * Root of all IPT events. All IPT events are considered dead and should no
 ...
 * 
 */
public abstract class IptEvent<H extends EventHandler> {
  /**
   ...
   * including class literals in the the compiled output. Use {@link IptEvent}
   ...
   * event can be revived by calling {@link IptEvent#revive()}.
   */
