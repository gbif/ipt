...
public class InvalidConfigException extends Exception {
  public enum TYPE {
    INVALID_BASE_URL, INVALID_DATA_DIR, NON_WRITABLE_DATA_DIR, IPT_CONFIG_WRITE, USER_CONFIG, REGISTRY_CONFIG, INVALID_EXTENSION, DATADIR_ALREADY_REGISTERED, ORGANISATION_CONFIG
  };
