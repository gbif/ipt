...
public class InvalidConfigException extends RuntimeException {
  public enum TYPE {
    INVALID_BASE_URL, INVALID_DATA_DIR, NON_WRITABLE_DATA_DIR, CONFIG_WRITE, USER_CONFIG, REGISTRY_CONFIG, INVALID_EXTENSION, DATADIR_ALREADY_REGISTERED, RESOURCE_ALREADY_REGISTERED, REGISTRATION_CONFIG, RESOURCE_CONFIG, EML, INVALID_PROXY
  };
