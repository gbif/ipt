<archive xmlns="http://rs.tdwg.org/dwc/terms/xsd/archive/">
  <file encoding="UTF-8" fieldsTerminatedBy="," linesTerminatedBy="\n" fieldsEnclosedBy='"' ignoreHeaderLines="1" rowType="${coreView.extension.rowType}" location="${coreFilename}">
   ...
   <#if isChecklist>
    ...
    <field index="6" term="http://rs.tdwg.org/dwc/terms/HigherTaxonID"/>
    <field index="7" term="http://rs.tdwg.org/dwc/terms/HigherTaxon"/>
    <field index="8" term="http://rs.tdwg.org/dwc/terms/BasionymID"/>
    <field index="9" term="http://rs.tdwg.org/dwc/terms/Basionym"/>
   </#if>
