...
<div id="agentPanel" class="newline">
  ...
  <div id="creator">    
    ...
    <div class="newline"></div>
    <div class="leftxhalf">
      <@s.textfield id="phone" key="eml.resourceCreator.address.phone"  
        cssClass="text xhalf"/>
    </div>
    <div class="leftxhalf">
      <@s.textfield id="email" key="eml.resourceCreator.address.email"  
        required="true" cssClass="text xhalf"/>
    </div>
    <div class="newline"></div>
    <div>
  ...
  <div id="creator">    
    ...
    <div class="leftxhalf">
      <@s.select id="metadataProviderCountry" key="" list="eml.responsibleParty.address.country"
        required="true" cssClass="text xhalf"/>
    </div>    
    <div class="newline"></div>
    <div class="newline"></div>
