...
<@display.table name="taxa" uid="tax" class="table" requestURI="" id="taxonList" export=false pagesize=50>
    <@display.column property="scientificName" sortable=true href="taxDetail.html?resource_id=${resource_id?c}" media="html" paramId="guid" paramProperty="guid" titleKey="taxon.scientificName"/>
