 ...
 * @param <T>
 */
public class GenericManagerImpl<T> extends org.appfuse.service.impl.GenericManagerImpl<T, Long> implements GenericManager<T> {
    private UploadEventDao dao;

    public GenericManagerImpl(final GenericDao<T, Long> genericDao) {
		super(genericDao);
    }
