...
public class GbifOrganisation implements Serializable {

  /**
   * This class builds {@link GbifOrganisation} instances using the builder
   * pattern.
   * 
   */
  public static class Builder {
    ...
    public GbifOrganisation build() {
      return new GbifOrganisation(this);
    }
  ...
  private GbifOrganisation(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GbifOrganisation)) {
      return false;
    }
    GbifOrganisation o = (GbifOrganisation) other;
