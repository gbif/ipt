...
GBIF automatically attempts to reindex all registered datasets every 7 days. **Note, however, GBIF will only reindex the dataset if its last published date has changed since the last time it was indexed**. 
