...
| `Sampling Methods` | a section with information about the sampling methodology used in creating the dataset, similar to a description of sampling procedures found in the methods section of a journal article. _Note this is required for sampling event datasets._ | _"BID-AF2015-0134-REG"_ |