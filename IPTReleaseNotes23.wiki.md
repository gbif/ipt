...
New in IPT 2.3 is the ability to publish sampling event resources. In order to enable this feature, the IPT administrator must install the Darwin Core Event Core Type. Note the Event Core is installed by default in new installations. 
