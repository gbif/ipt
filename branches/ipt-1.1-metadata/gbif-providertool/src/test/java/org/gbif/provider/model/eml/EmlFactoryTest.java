...
public class EmlFactoryTest extends TestCase {
	...
	public void testBuild() {
		try {
			...
			// this is a pretty complete test for agents so future tests will not be  so extensive
	        ...
	        // The following tests should be used when the Digester handles associatedMetadata
...
//	        assertEquals("dataset", eml.getMetadataLanguage());
//	        
