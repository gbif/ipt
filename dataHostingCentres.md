...
[GBIF France](http://www.gbif.fr/) provides helpdesk support to new publishers and hosts an IPT for each of these countries:
...
The [Taiwan Biodiversity Information Facility (TaiBIF)](http://www.taibif.tw/en) provides helpdesk support to new publishers in Taiwan, and hosting support for datasets on the [TaiBIF IPT](http://ipt.taibif.tw/). Please contact Melissa Liu <melissaliu0520@gmail.com> for assistance. 
