...
public class IptI18nInterceptor extends I18nInterceptor {
  ...
  private static final Set<Locale> IPT_SUPPORTED_LOCALES = Sets
    .newHashSet(Locale.ENGLISH, Locale.FRENCH, Locale.CHINESE, Locale.JAPANESE, new Locale("es"), new Locale("pt"),
      new Locale("ru"), new Locale("fa"));
