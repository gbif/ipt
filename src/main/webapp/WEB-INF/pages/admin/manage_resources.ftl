...
<#escape x as x?html>
    ...
    <#include "/WEB-INF/pages/macros/adminManageResourcesTable.ftl"/>
    ...
    <@adminManageResourcesTable resources=resources shownPublicly=true numResourcesShown=10 sEmptyTable="dataTables.sEmptyTable.resources" columnToSortOn=1 sortOrder="asc" />
