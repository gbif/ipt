                        ...
                        <div class="table-responsive mx-md-4 mx-2">
                            <table class="table table-sm table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td class="separator green">${resource.emlVersion.toPlainString()}&nbsp;<a class="btn btn-outline-success ignore-link-color" role="button" href="${baseURL}/resource?r=${resource.shortname}">${viewTitle?cap_first}'</a><@dwcaValidator/></td></#if><td class="left_padding">${resource.getNextVersion().toPlainString()}&nbsp;<a class="btn ignore-link-color <#if missingMetadata>btn-outline-secondary disabled<#else>btn-outline-success</#if> " role="button" href="${baseURL}/resource/preview?r=${resource.shortname}">${previewTitle?cap_first}</a></td>
                                </tr>
