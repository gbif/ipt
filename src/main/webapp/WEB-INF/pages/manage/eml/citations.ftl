        ...
        $(document).ready(function(){
            ...
            function populateCitationWithAutoGeneratedCitation() {
                ...
                if (isAutoGenerated) {
                    ...
                    var autoCitation;
                    <#attempt>
                    autoCitation = "${action.resource.generateResourceCitation(resource.getNextVersion().toPlainString()?string, cfg.getResourceVersionUri(resource.getShortname(), resource.getNextVersion().toPlainString()?string))!}";
                    <#recover>
                    autoCitation = "";
                    </#attempt>
