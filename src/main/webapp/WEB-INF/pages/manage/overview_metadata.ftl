        ...
        <div class="d-flex justify-content-end align-items-center">
            ...
            <div class="dropdown me-2">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="metadataDropdown">
                    ...
                    <#if resource.isDatapackage() && resource.dataPackageIdentifier?contains("dwc-dp")>
                        <li>
                        ...
                        <li>
                            <a id="edit-metadata-button" class="btn btn-sm btn-outline-gbif-primary w-100 dropdown-button" type="button" href="datapackage-metadata-basic.do?r=${resource.shortname}">
