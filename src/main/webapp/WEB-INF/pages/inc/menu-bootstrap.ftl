...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark">
        ...
        c1.4,0.7,3.6-1.5,4.9-2.7c20.6-19.1,47.9-28.4,74.2-28.4c60.7,0,103.4,50.3,133.7,80.5C401.3,704.3,464.8,731.2,534.3,731"/>
            ...
            <a class="navbar-brand" href="${baseURL}/">GBIF IPT</a>
            ...
            <div class="offcanvas-collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <li class="nav-item">
                        <a class="nav-link" href="${baseURL}/">[@s.text name="menu.home"/]</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${baseURL}/manage/">[@s.text name="menu.manage"/]</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${baseURL}/admin/">[@s.text name="menu.admin"/]</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${baseURL}/about.do">[@s.text name="menu.about"/]</a>
                    </li>
                </ul>
                <div class="d-flex">
