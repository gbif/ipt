    ...
    <script charset="utf-8">
        ...
        var aDataSet = [
            ...
            ['<a href="user?id=${u.email?replace("'", "\\'")?replace("\"", '\\"')!}">${u.name?replace("'", "\\'")?replace("\"", '\\"')!}</a>',
                ...
                '<a class="icon-button icon-button-sm" type="button" href="user?id=${u.email?replace("'", "\\'")?replace("\"", '\\"')!}">' +
                ...
                '</svg>' +
                '</a>' +
                '<label class="confirmPasswordReset icon-button icon-button-sm">' +
                ...
                '</label>' +
                '<label title="Delete user" class="userConfirmDeletion icon-button icon-button-sm">' +
