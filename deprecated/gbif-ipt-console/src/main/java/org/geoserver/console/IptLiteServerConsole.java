 ...
 *
 */
public class IptLiteServerConsole {
	private static final String APPNAME = "IPT-lite";
    ...
    public static class DebugHandler implements JettyHandler {
        ...
        void initServer(Server server ) {
            ...
            WebAppContext wahIPT = new WebAppContext();
            wahIPT.setContextPath("/ipt");
            wahIPT.setWar("src/main/webapp");
            wahIPT.setTempDirectory(new File("target/work"));
            server.addHandler(wahIPT);
        }
    ...
    public IptLiteServerConsole(JettyHandler handler) {
    ...
    class Frame extends JFrame {
        ...
        void initComponents() {
            ...
            setSize( 550, 350 );
            setTitle( APPNAME );
            setIconImage( Toolkit.getDefaultToolkit().createImage( IptLiteServerConsole.class.getResource( "gs.gif")) );
            pack();
            ...
            addWindowListener(new WindowAdapter(){
                ...
                public void windowClosing(WindowEvent e) {
                    ...
                    if ( started ) {
                        String msg = "Would you like to shutdown "+APPNAME+" before exiting?";
        ...
        void stopping() {
            statusLabel.setText( APPNAME+" is stopping...");
            statusLabel.setIcon( new ImageIcon( getClass().getResource( "stopping.png")));
            shutDownMenuItem.setEnabled(false);
        }
        
        void stopped() {
            statusLabel.setText( APPNAME+" is stopped.");
