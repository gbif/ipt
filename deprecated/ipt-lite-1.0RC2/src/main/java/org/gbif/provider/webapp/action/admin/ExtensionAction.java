...
public class ExtensionAction extends BaseAction {
    ...
    private Map<String, List<ExtensionProperty>> properties = new HashMap<String, List<ExtensionProperty>>();
	...
	public String execute(){
    	...
    	for (ExtensionProperty prop : extension.getProperties()){
        	String group = prop.getGroup()==null ? extension.getName() : prop.getGroup();
