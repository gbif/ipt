...
public class GbrdsExtension implements Serializable {

  public static GbrdsExtension create(int id, String title, String url) {
    checkNotNull(id);
    checkNotNull(title);
    checkNotNull(url);
    return new GbrdsExtension(id, title, url);
  }
  ...
  private GbrdsExtension(int id, String title, String url) {
    this.id = id;
    this.title = title;
    this.url = url;
  }
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GbrdsExtension)) {
      return false;
    }
    GbrdsExtension o = (GbrdsExtension) other;
