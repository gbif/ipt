 ...
 * 
 * Because an extension can reference thesauri, this is a 2 pass parsing process.
...
public class ExtensionFactory {
	 ...
	 * @throws IOException 
	 */
	public static Extension build(InputStream is, Map<String, ThesaurusVocabulary> url2ThesaurusMap) throws IOException, SAXException {
	...
	/**
	 * Returns the thesaurus URLs or an empty set of the thesaurus referenced by the extension
	 * @param extensionUrl To check
	 * @return The Set<String> urls
	 */
	public static Set<String> thesaurusURLs(String extensionUrl) throws IOException, SAXException {
	...
	/**
	 * This will parse the given stream, looking for thesaurus URLs referenced in the extension  
	 * @param is To parse
	 * @return A Set<String> that represent URLs for thesauri referenced in the extensions definition 
	 * @throws IOException Unable to access the extension
	 * @throws SAXException Unable to parse response
	 */
	public static Set<String> thesaurusURLs(InputStream is) throws IOException, SAXException {
		Digester digester = new Digester();
		digester.setNamespaceAware(false);
