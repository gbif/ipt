...
4. Use the GBIF Integrated Publishing Toolkit (IPT) to fill in your dataset metadata, publish your dataset in a standardised Darwin Core format, and register it with GBIF
