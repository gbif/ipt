...
### C. New Features / Other
  * IPT 2.3.3 shows record counts for all files in the DwC-A inside a bar graph on the "Data Records" section of the resource homepage. **Warning**: for the bar graph showing the record counts by extension to appear, resource managers must republish the resource. 
