...
<@s.form id="emlForm" action="collections" enctype="multipart/form-data" 
  method="post">  
...
<h2 class="explMt"><@s.text name="eml.curatorialUnit"/></h2>
...
<div id="curatorialUnitPanel" class="newline">
  ...
  <div id="cloneCuratorialUnit">
    ...
    <div class="newline"></div>
    <div class="right">
      <a id="removeLink" href="" onclick="return false;">[ <@s.text name='metadata.removethis'/> <@s.text name='eml.curatorialUnit'/> ]</a>
    </div>
    <div class="newline"></div>

      <div id="CuratorialUnitDiv">
        <div id="rangeStartDiv" class="leftxhalf">
          <@s.textfield id="rangeStart" key="" 
          label="%{getText('jgtiCuratorialUnit.rangeStart')}" required="false" cssClass="text text xhalf slim"/>
        </div>
        <div id="rangeEndDiv" class="leftxhalf">
          <@s.textfield id="rangeEnd" key="" 
          label="%{getText('jgtiCuratorialUnit.rangeEnd')}" required="false" cssClass="text xhalf slim"/>
        </div>
        <div class="newline"></div>
        <div id="uncertaintyMeasureDiv" class="leftxhalf">
          <@s.textfield id="uncertaintyMeasure" key="" 
          label="%{getText('jgtiCuratorialUnit.uncertaintyMeasure')}" required="false" cssClass="text text xhalf slim"/>
        </div>
        <div id="unitTypeDiv" class="leftxhalf">
          <@s.textfield id="unitType" key="" 
          label="%{getText('jgtiCuratorialUnit.unitType')}" required="false" cssClass="text text xhalf slim"/>
        </div>
      </div>
...
<div class="left">
  <a id="plus" href="" onclick="return false;"><@s.text name='metadata.addnew'/> <@s.text name='eml.curatorialUnit'/></a>
</div>
<div class="newline"></div>
<div class="newline"></div>
<div class="newline"></div>    
