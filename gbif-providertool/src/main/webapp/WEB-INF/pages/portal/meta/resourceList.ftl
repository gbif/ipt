<head>
	...
	<script type="text/javascript">
	 ...
	 $(document).ready(function(){
		...
		so.addVariable("swf", "");
		var data = '[<#list resources as r><#if (r.geoCoverage.min.x)??>{"id":${r.id?c},"title":"${r.title?js_string}","count":${r.recordCount!0},"minx":${r.geoCoverage.min.x?c},"maxx":${r.geoCoverage.max.x?c},"miny":${r.geoCoverage.min.y?c},"maxy":${r.geoCoverage.max.y?c}},</#if></#list>';
