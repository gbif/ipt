...
public class GbrdsResource implements Serializable {
  ...
  public static class Builder {
    ...
    public GbrdsResource build() {
      return new GbrdsResource(this);
    }
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GbrdsResource)) {
      return false;
    }
    GbrdsResource o = (GbrdsResource) other;
