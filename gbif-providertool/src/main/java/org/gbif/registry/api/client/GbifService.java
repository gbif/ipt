...
public class GbifService implements Serializable {
  ...
  public static class Builder {
    ...
    public GbifService build() {
      return new GbifService(this);
    }
  ...
  public GbifService(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GbifService)) {
      return false;
    }
    GbifService o = (GbifService) other;
