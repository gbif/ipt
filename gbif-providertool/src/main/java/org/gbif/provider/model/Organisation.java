...
/**
 * This class can be used to encapsulate information about an organisation
...
public class Organisation {
  ...
  /**
   * This class can be used to construct Organisation instances using the
   * builder pattern.
   * 
   */
  ...
  /**
   * Returns an organisation builder.
   */
  ...
  public boolean equals(Object obj) {
    ...
    return equal(name, o.name) 
        && equal(description, o.description)
        && equal(homepageUrl, o.homepageUrl)
        && equal(nameLanguage, o.nameLanguage)
        && equal(descriptionLanguage, o.descriptionLanguage)
        && equal(primaryContact, o.primaryContact) 
        && equal(nodeKey, o.nodeKey)
        && equal(nodeName, o.nodeName) 
        && equal(user, o.user) 
        && equal(organisationKey, o.organisationKey)
  ...
  public int hashCode() {
    return Objects.hashCode(name, description, homepageUrl, nameLanguage,
        ...
        organisationKey, password);
  }

  public boolean isRegistered() {
    return organisationKey != null && trimToNull(organisationKey) != null;
  }
  ...
  public String toString() {
    return String.format(
        "Name=%s, Description=%s, HomepageUrl=%s, NameLanguage=%s, DescriptionLanguage=%s, PrimaryContact=[%s], NodeKey=%s, NodeName=%s, User=%s, OrganisationKey=%s, Password=%s",
        name, description, homepageUrl, nameLanguage, descriptionLanguage,
        primaryContact, nodeKey, nodeName, user, organisationKey, password);
  }
}
