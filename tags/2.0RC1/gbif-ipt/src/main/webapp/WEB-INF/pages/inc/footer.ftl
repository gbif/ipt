			...
			<div id="footer">
				<ul>
					<li><@s.text name="footer.version"/> ${cfg.version!"???"}</li>
					...
					<li><a href="http://code.google.com/p/gbif-providertoolkit/issues/entry?template=Feature%20request"><@s.text name="footer.featureRequest"/></a></li>
