...
<img src='https://github.com/gbif/ipt/wiki/gbif-ipt-docs/figures/dwc-a_event.png' width="600" height="400" alt="The components of a Darwin Core Archive." />
...
<img src='https://github.com/gbif/ipt/wiki/gbif-ipt-docs/figures/core_data_file.png' width="601" height="124" alt="A core data file is a simple, tabular, text file" />
...
<img src='https://github.com/gbif/ipt/wiki/gbif-ipt-docs/figures/extension_data_file.png' width="601" height="124" alt="An extension is linked to the core file via the common taxon ID" />
...
<img src='https://github.com/gbif/ipt/wiki/gbif-ipt-docs/figures/meta_file.png' width="557" height="166" alt="The metafile describes the file names and fields in the core and extension files" />
...
<img src='https://github.com/gbif/ipt/wiki/gbif-ipt-docs/figures/metadata_file.png' width="605" height="182" alt="A metadata document describes the complete dataset" />
...
The [Integrated Publishing Toolkit (IPT)](https://www.gbif.org/ipt) is GBIF’s flagship tool for publishing DwC-As.
...
The IPT can be used to publish resource metadata, occurrence data, checklist data, and sampling-event data. The guide [How to publish biodiversity data through GBIF.org](howToPublish) provides a simple set of instructions how to do so.
...
To publish the data as a DwC-A, upload the templates to the IPT. Use the IPT's built-in metadata editor to enter dataset metadata. The guide [How to publish biodiversity data through GBIF.org](howToPublish) provides a simple set of instructions how to do so. If you require an account on an IPT, it is highly recommended that you request an account on a [trusted data hosting centre](dataHostingCentres) located in your country.
...
3. Create a metadata file (eml.xml) that describes the data resource. Complete instructions on doing this are available in the [GBIF Extended Metadata Profile: How-To Guide](http://links.gbif.org/gbif_metadata_profile_guide_en_v1). It is best practice to include a metadata file and the simplest way to produce one is using the IPT's built-in metadata editor.
...
Advanced users can request permission to register datasets in bulk, by integrating the GBIF API into their existing systems.  A [basic example](https://github.com/gbif/registry/tree/master/registry-examples/src/test/scripts) is provided as a Linux (Bash) shell script; contact the helpdesk for more information.

## Annex: Preparing Your Data

### Required and recommended terms

The guide [How to publish biodiversity data through GBIF.org](howToPublish) provides a set of required and recommended terms for each type of data:
...
The guide [How to publish biodiversity data through GBIF.org](howToPublish) provided a set of example DwC-As for each type of data:
