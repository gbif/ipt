...
public class JdbcInfoTest {
	  ...
	  public void testSql() {
		  ...
		  JdbcInfo info = support.new JdbcInfo("mysql","MySQL","com.mysql.jdbc.Driver","jdbc:mysql://{host}/{database}","","","LIMIT ?");		  
		  ...
		  info = support.new JdbcInfo("mysql","MySQL","com.mysql.jdbc.Driver","jdbc:mysql://{host}/{database}","TOP ?","","");		  
		  ...
		  info = support.new JdbcInfo("mysql","MySQL","com.mysql.jdbc.Driver","jdbc:mysql://{host}/{database}","","rownum <= ?","");		  
