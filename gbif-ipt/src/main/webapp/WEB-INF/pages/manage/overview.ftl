...
<div class="report">
  ...
  <ul class="simple">
   ...
   <li>${msg}</li>
			  	 ...
			  	 <#if rtfFileExisting><tr><th><@s.text name="portal.resource.published.rtf"/></th><td><a href="${baseURL}/rtf.do?r=${resource.shortname}"><@s.text name="manage.overview.published.download"/></a> </td></tr></#if>
			  	</#if>
      		</table>
      	</div>
  </div>
