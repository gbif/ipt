...
public interface ConfigManager {
	...
	/** Simple wrapper around AppConfig to set the google maps api key
	 * The modified AppConfig is not immediately persisted - remember to call save() at some point!
	 * @param key
	 * @throws InvalidConfigException
	 */
	 ...
	 * @param dataDir a valid, writable directory. If empty a new skeleton will be used, if its an existing, valid IPT data dir it will be read.
	...
	/**Persists the main IPT AppConfig configuration which can be modified for simple properties independently of this manager as its a singleton.
