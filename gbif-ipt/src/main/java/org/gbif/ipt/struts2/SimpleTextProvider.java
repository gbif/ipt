...
/** A basic text provider for internationalised messages that can replace the native struts2 one.
 * It uses only a single bundle name to speed up the lookup which increases performance of page rendering 
 * with many text blocks by sometimes more than 100%
 * 
 * @author markus
 *
 */
