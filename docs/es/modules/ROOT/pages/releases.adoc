...
====
The current, stable release is version <<3-0-6-june-2024,3.0.6>>.
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.0.6/ipt-3.0.6.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.0.6 Release Notes]
