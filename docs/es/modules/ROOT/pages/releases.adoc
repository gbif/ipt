...
#Release candidate# version 2.5.0-RC1. Users may test this pre-release version following the instructions in the xref:2.5@release-notes.adoc[Release Notes].
