...
====
The current, stable release is version <<3-3-6-september-2026,3.3.5>>.

ifeval::["{language}" != "en"]
Estás leyendo la versión más reciente del manual. Puedes consultar versiones anteriores usando los selectores situados en la esquina superior derecha o inferior izquierda de la pantalla. Ten en cuenta que no todas las versiones del manual están disponibles en Español.
endif::[]
====

== *3.3.6* – September 2026

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.6/ipt-3.3.6.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.3.6 Release Notes]
* xref:index.adoc[Manual del Usuario]
* Addressed https://github.com/gbif/ipt/milestone/80?closed=1[1 issue].
* Traducida en 7 idiomas

This minor release fixes license-related publication issues.

Los usuarios actuales deben actualizar a esta versión siguiendo las instrucciones que se indican en el archivo xref:release-notes.adoc [Notas de la versión]. Asegúrese de que está utilizando una versión compatible de Tomcat, ya que Tomcat 9 ya no es compatible. Los nuevos usuarios deben seguir la xref:getting-started.adoc [Guía de inicio].
...
== *3.3.5* – September 2026

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.5/ipt-3.3.5.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.3.5 Release Notes]
* xref:index.adoc[Manual del Usuario]
* Addressed https://github.com/gbif/ipt/milestone/78?closed=1[9 issues].
* Traducida en 7 idiomas

Esta versión menor incorpora mejoras de seguridad.

== *3.3.4* – julio 2026

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.4/ipt-3.3.4.war[Descargar WAR], xref:installation.adoc#installation-from-linux-packages[paquetes de Linux] o xref:installation.adoc#installation-from-docker[usar Docker]
* xref:release-notes.adoc[Notas de la versión IPT v3.3.4]
* xref:index.adoc[Manual del Usuario]
* Abordadas https://github.com/gbif/ipt/milestone/77?closed=1[3 incidencias].
* Traducida en 7 idiomas
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.2/ipt-3.3.3.war[Descargar WAR], xref:installation.adoc#installation-from-linux-packages[Paquetes Linux] o xref:installation.adoc#installation-from-docker[Usar Docker]
* xref:release-notes.adoc[Notas de la versión IPT v3.3.3]
* xref:index.adoc[Manual del Usuario]
* Abordadas https://github.com/gbif/ipt/milestone/76?closed=1[15 incidencias].
* Traducida en 7 idiomas

Esta actualización menor introduce identificadores ROR y notificaciones por correo electrónico, junto con varias correcciones de errores y mejoras de seguridad.

== *3.3.2* – Mayo 2026

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.2/ipt-3.3.2.war[Descargar WAR], xref:installation.adoc#installation-from-linux-packages[Paquetes Linux] o xref:installation.adoc#installation-from-docker[Usar Docker]
* xref:release-notes.adoc[Notas de la versión IPT v3.3.2]
* xref:index.adoc[Manual del Usuario]
* Abordadas https://github.com/gbif/ipt/milestone/75?closed=1[5 incidencias].
* Traducida en 7 idiomas
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.1/ipt-3.3.1.war[Descargar WAR], xref:installation.adoc#installation-from-linux-packages[Paquetes de Linux] o xref:installation.adoc#installation-from-docker[usar Docker]
* xref:release-notes.adoc[Notas de la versión IPT v3.3.1]
* xref:index.adoc[Manual del Usuario]
* Abordadas https://github.com/gbif/ipt/milestone/74?closed=1[9 incidencias].
* Traducida en 7 idiomas
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.0/ipt-3.3.0.war[Descargar WAR], xref:installation.adoc#installation-from-linux-packages[Paquetes de Linux] o xref:installation.adoc#installation-from-docker[usar Docker]
* xref:release-notes.adoc[Notas de la versión IPT v3.3.0]
* xref:index.adoc[Manual del Usuario]
* Abordadas https://github.com/gbif/ipt/milestone/72?closed=1[31 incidencias].
* Traducida en 7 idiomas

Esta importante versión incluye actualizaciones de las librerías internas, lo que permite la compatibilidad con las últimas versiones de Tomcat (10.1/11) y Java 17, además de varias funciones nuevas.


== *3.2.3* – Marzo 2026

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.2.3/ipt-3.2.3.war[Descargar WAR], xref:installation.adoc#installation-from-linux-packages[Paquetes de Linux] o xref:installation.adoc#installation-from-docker[usar Docker]
* xref:release-notes.adoc[Notas de la versión IPT v3.2.3]
* xref:index.adoc[Manual del Usuario]
* Abordadas https://github.com/gbif/ipt/milestone/73?closed=1[5 incidencias].
* Traducida en 7 idiomas
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.2.2/ipt-3.2.2.war[Descargar WAR], xref:installation.adoc#installation-from-linux-packages[Paquetes de Linux] o xref:installation.adoc#installation-from-docker[usar Docker]
* xref:release-notes.adoc[Notas de la versión IPT v3.2.2]
* xref:index.adoc[Manual del Usuario]
* Abordadas https://github.com/gbif/ipt/milestone/71?closed=1[7 incidencias].
* Traducida en 7 idiomas

Esta versión menor trae correcciones de errores.


== *3.2.1* – Diciembre 2025

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.2.1/ipt-3.2.1.war[Descargar WAR], xref:installation.adoc#installation-from-linux-packages[Paquetes de Linux] o xref:installation.adoc#installation-from-docker[usar Docker]
* xref:release-notes.adoc[Notas de la versión de IPT v3.2.1]
* xref:index.adoc[Manual del Usuario]
* Abordadas https://github.com/gbif/ipt/milestone/70?closed=1[2 incidencias].
* Traducida en 7 idiomas

Esta versión menor trae correcciones de errores relacionados con la publicación.


== *3.2.0* – Diciembre 2025

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.2.0/ipt-3.2.0.war[Descargar WAR], xref:installation.adoc#installation-from-linux-packages[Paquetes de Linux] o xref:installation.adoc#installation-from-docker[usar Docker]
* xref:release-notes.adoc[Notas de la versión de IPT v3.2.0]
* xref:index.adoc[Manual del Usuario]
* Abordadas https://github.com/gbif/ipt/milestone/68?closed=1[84 incidencias].
* Traducida en 7 idiomas

Esta nueva versión incluye actualizaciones de las bibliotecas internas, junto con numerosas mejoras y correcciones de errores.
