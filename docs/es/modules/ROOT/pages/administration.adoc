...
* *URL de redireccionamiento del logotipo*: habilita la redirección del logotipo principal a otra ubicación, con el valor predeterminado establecido en la URL pública del IPT.
