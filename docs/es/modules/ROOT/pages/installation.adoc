...
NOTE: Packages for Red Hat 8/9, CentOS 8/9 Stream, Rocky Linux 8/9 or similar are being developed. Please see https://github.com/gbif/ipt/issues/1646[this issue] if you can help with testing.
