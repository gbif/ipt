...
El IPT se ha probado y funciona correctamente con las versiones recientes de Tomcat 10.1 y 11. Tomcat 9 y las versiones anteriores ya no son compatibles. La documentación de Apache Tomcat se puede consultar en https://tomcat.apache.org/.
