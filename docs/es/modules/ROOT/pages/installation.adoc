...
El IPT ha sido probado y funciona correctamente con versiones recientes de Tomcat 9. Tomcat 10 y versiones posteriores no son compatibles actualmente. Tomcat 8 no es compatible con el IPT, ya que Apache ni las principales distribuciones de Linux ya no lo son. La documentación de Apache Tomcat está disponible en https://tomcat.apache.org/.
