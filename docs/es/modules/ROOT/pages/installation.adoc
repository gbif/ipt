...
NOTE: Se están desarrollando paquetes para Red Hat 8/9, CentOS 8/9 Stream, Rocky Linux 8/9 o similares. Por favor, consulte https://github.com/gbif/ipt/issues/1646[este issue] si puede ayudar con las pruebas.
