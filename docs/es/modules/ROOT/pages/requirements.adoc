...
La versión actual del IPT ha sido probada para funcionar en Java 17. Consulte la hoja de ruta de versiones de OpenJDK (https://adoptopenjdk.net/support.html#roadmap), la hoja de ruta de versiones de Oracle Java (https://www.oracle.com/java/technologies/java-se-support-roadmap.html) o la documentación de su distribución de Linux para obtener una visión general de cuánto tiempo se seguirá dando soporte a su versión de Java.
