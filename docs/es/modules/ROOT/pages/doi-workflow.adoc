...
En la página Administrar Recursos, en xref:manage-resources#publication[Publication], la tabla que muestra la versión pendiente incluye opciones adicionales para gestionar los DOI. El botón {doiicon} permite asignar un nuevo DOI a un recurso. Al asignar un nuevo DOI, también se aumenta la versión principal del recurso.
