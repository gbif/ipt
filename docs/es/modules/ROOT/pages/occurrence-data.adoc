...
link:{attachmentsdir}/downloads/occurrence_ipt_template_v2.3.xlsx[image:ipt2/excel-template2.png[Plantilla de Excel]] link:{attachmentsdir}/downloads/occurrence_ipt_template_v2.3_example_data.xlsx[image:ipt2/excel-template-data2.png[Plantilla de Excel (con datos de ejemplo)]]

Complételo y cárguelo en el IPT. Intente ampliarla incluyendo la mayor cantidad posible de https://rs.gbif.org/extensions.html[elementos del Core Occurrence y de las extensiones soportadas por GBIF]. Puede ampliar su tabla principal con columnas DwC adicionales, pero sólo con elementos DwC de esta {latest-dwc-occurrence}[lista].

=== Campos DwC requeridos y recomendados

Puede consultar los campos obligatorios y recomendados en https://techdocs.gbif.org/en/data-publishing/data-quality-recommendations#data-quality-requirements-for-occurrences[Requisitos de calidad de datos para registros biológicos].
