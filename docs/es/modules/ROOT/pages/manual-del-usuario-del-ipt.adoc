...
* Cargar los datos a una de las xref:{latest-manual-version}@database-connection.adoc[bases de datos soportadas por el IPT]
...
* *Perfil en línea* - La URL del perfil en línea al que pertenece el identificador personal. Hay cuatro directorios predeterminados para escoger: ORCID, ResearchID, LinkedIn, y Google Scholar. Si desea cambiar los directorios predeterminados del IPT consulte xref:{latest-manual-version}@user-id.adoc[How To Add a New User ID Directory] en la página del wiki del IPT.
...
Los desarrolladores que deseen contribuir, o utilizar la última revisión del código fuente para su instalación deberán consultar la sección xref:{latest-manual-version}@developer-guide.adoc[How to Contribute] del wiki del IPT.
...
Esta página wiki da detalles acerca de la preparación de un servidor para ejecutar el IPT y se puede encontrar en el sitio en código de la wiki del proyecto IPT en xref:{latest-manual-version}@server-preparation.adoc[Server Preparation].

=== Bases de Datos del IPT Soportadas
Esta página wiki da detalles acerca de los sistemas de administración de bases de datos a los que el IPT se pueden conectar para obtener una fuente de datos. La página se puede encontrar en el sitio en código del proyecto IPT xref:{latest-manual-version}@database-connection.adoc[here].
