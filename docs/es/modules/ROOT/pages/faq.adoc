...
Además, por favor contacte con el servicio de asistencia de GBIF (helpdesk@gbif.org) y solicite que se actualice la información de la organización en el Registro de GBIF (este paso es muy importante, ya que el cambio no será visible en gbif.org hasta que se haya realizado). En su correo electrónico, incluya una breve explicación del motivo del cambio, el enlace al conjunto de datos y el UUID del nuevo publicador.
