...
Example table sorted in ascending order by the column labelled "Name". image:ipt2/Control-TableSortedAscending.png[]

Example table sorted in descending order by the column labelled "Type". image:ipt2/Control-TableSortedDescending.png[]
