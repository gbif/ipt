...
ifeval::["{language}" != "en"]
You are reading the latest version of the manual. You can read older versions of the manual using the selectors at the top-right or bottom-left of the screen. Note that not all manual versions are available in TRANSLATOR_PUT_YOUR_LANGUAGE_HERE.
endif::[]
====
...
Existing users should upgrade to this version following the instructions in the xref:release-notes.adoc[Release Notes]. Please ensure you are using a supported version of Tomcat, as Tomcat 9 is no longer supported. New users should follow the xref:getting-started.adoc[Getting Started guide].
...
This minor release brings security improvements.

== *3.3.4* – July 2026

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.4/ipt-3.3.4.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.3.4 Release Notes]
* xref:index.adoc[User Manual]
* Addressed https://github.com/gbif/ipt/milestone/77?closed=1[3 issues].
* Translated into 7 languages
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.3/ipt-3.3.3.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.3.3 Release Notes]
* xref:index.adoc[User Manual]
* Addressed https://github.com/gbif/ipt/milestone/76?closed=1[15 issues].
* Translated into 7 languages

This minor release introduces ROR identifiers and email notifications, along with various bug fixes and security improvements.

== *3.3.2* – May 2026

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.2/ipt-3.3.2.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.3.2 Release Notes]
* xref:index.adoc[User Manual]
* Addressed https://github.com/gbif/ipt/milestone/75?closed=1[5 issues].
* Translated into 7 languages
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.1/ipt-3.3.1.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.3.1 Release Notes]
* xref:index.adoc[User Manual]
* Addressed https://github.com/gbif/ipt/milestone/74?closed=1[9 issues].
* Translated into 7 languages
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.3.0/ipt-3.3.0.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.3.0 Release Notes]
* xref:index.adoc[User Manual]
* Addressed https://github.com/gbif/ipt/milestone/72?closed=1[31 issues].
* Translated into 7 languages

This major release includes upgrades to internal libraries, enabling support for the latest versions of Tomcat (10.1/11) and Java 17, along with several new features.


== *3.2.3* – March 2026

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.2.3/ipt-3.2.3.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.2.3 Release Notes]
* xref:index.adoc[User Manual]
* Addressed https://github.com/gbif/ipt/milestone/73?closed=1[5 issues].
* Translated into 7 languages
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.2.2/ipt-3.2.2.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.2.2 Release Notes]
* xref:index.adoc[User Manual]
* Addressed https://github.com/gbif/ipt/milestone/71?closed=1[7 issues].
* Translated into 7 languages
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.2.1/ipt-3.2.1.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.2.1 Release Notes]
* xref:index.adoc[User Manual]
* Addressed https://github.com/gbif/ipt/milestone/70?closed=1[2 issues].
* Translated into 7 languages

This minor release brings bug fixes related to publication.


== *3.2.0* – December 2025

* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/3.2.0/ipt-3.2.0.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
* xref:release-notes.adoc[IPT v3.2.0 Release Notes]
* xref:index.adoc[User Manual]
* Addressed https://github.com/gbif/ipt/milestone/68?closed=1[84 issues].
* Translated into 7 languages

This major release includes upgrades to internal libraries, along with numerous improvements and bug fixes.
