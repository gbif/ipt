...
From this point, the process is very similar to using a file as a data source.  See the <<File as a data source>> section for an explanation of the page.
