...
NOTE: IPT users should define the multi-value delimiter for each source file in the IPT. Refer to xref:manage-resources.adoc#_source_data[Source Data section] of the IPT User Manual for additional guidance.
