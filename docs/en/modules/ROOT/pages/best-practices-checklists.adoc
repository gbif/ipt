...
> GBIF (2017). Best Practices in Publishing Species Checklists. Accessible online at https://ipt.gbif.org/manual/en/ipt/{manual-version}/best-practices-checklists
