...
The IPT has been tested and works well with recent releases of Tomcat 9.  Later Tomcat versions should also work. The Apache Tomcat documentation can be found on https://tomcat.apache.org/.
