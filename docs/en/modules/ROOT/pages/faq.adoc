...
In addition to that, *please contact the GBIF Help Desk (helpdesk@gbif.org) and ask that the organization be updated in the GBIF Registry* (this part is very important and the change will not be visible on gbif.org until it is done). In your email, please include a brief explanation of why the change was made, the link to the dataset, and the UUID of the new publisher. 
