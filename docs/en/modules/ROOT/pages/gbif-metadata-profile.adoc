...
The xref:manage-resources.adoc#_metadata[IPT User Manual] goes through each form and its respective fields in some depth. The form provides help dialogs to aid the user in understanding what an element means (Figure 1).
