...
* Addressed https://github.com/gbif/ipt/milestone/28?closed=1[2 issues].
...
This version addresses a bug introduced in version 2.5.0, which prevented the IPT from connecting to database sources. Users who connect the IPT to database sources will need to upgrade to 2.5.1. If you do not use database sources then version 2.5.0 is equivalent.
