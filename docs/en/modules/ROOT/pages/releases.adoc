...
====
The current, stable release is version <<2-6-3-october-2022,2.6.3>>.
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/2.6.1/ipt-2.6.1.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-using-docker[use Docker]
