...
====
The current, stable release is version <<2-5-7-february-2022,2.5.7>>.
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/2.5.7/ipt-2.5.7.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
