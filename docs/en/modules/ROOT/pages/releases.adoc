...
* xref:release-notes.adoc[IPT v3.0-RC1 Release Notes]
...
Interested users may upgrade to this version following the instructions in the xref:release-notes.adoc[Release Notes], or create a new installation by following the xref:getting-started.adoc[Getting Started guide].
