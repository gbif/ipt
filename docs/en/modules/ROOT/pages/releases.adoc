...
====
The current, stable release is version <<2-5-6-february-2022,2.5.6>>.
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/2.5.6/ipt-2.5.6.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/2.5.5/ipt-2.5.5.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
