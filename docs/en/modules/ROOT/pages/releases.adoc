...
This version contains fixes to critical security issues with Struts and log4j libraries. All users are highly encouraged to upgrade to this version as soon as possible.
