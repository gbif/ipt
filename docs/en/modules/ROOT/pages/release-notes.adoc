...
* IPT 3.0.0 requires Tomcat 9 or later.

If you are upgrading from a version before 3.0.0, please also refer to the notes from the xref:2.5@release-notes.adoc[older release].
