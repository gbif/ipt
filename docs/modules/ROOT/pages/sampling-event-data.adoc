...
For extra guidance, you can refer to the guide xref:best-practices-sampling-event.adoc[Best Practices in Publishing Sampling-event data] and look at the <<Templates,template populated with example data>> or the list of <<Exemplar datasets,exemplar datasets>>.
