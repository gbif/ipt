...
* Citation DOI (remember to turn on citation xref:manage-resources.adoc#_citations[auto-generation], to ensure your dataset's citation complies with the xref:citation.adoc[best-practice format]).
