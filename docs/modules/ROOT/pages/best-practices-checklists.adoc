...
. To cite individuals at the record level, providing a 3<sup>rd</sup> level of citation, it is recommended to use the *dwc:nameAccordingTo* field. Additional record-level terms are provided above.
