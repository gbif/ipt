...
The IPT outputs a DwC-A during publishing and supports automatic registration in the GBIF network. See the xref:123-manage-resources.adoc#_visibility[IPT User Manual] for further details.
