...
| `Citation` | how the dataset should be cited. Use of the [IPT Citation Format](https://github.com/gbif/ipt/wiki/IPT2Citation.wiki) (based on DataCite's preferred citation format and that satisfies the [Joint Declaration of Data Citation Principles](https://www.force11.org/datacitation)) is highly recommended. | _"Edgar G J, Stuart-Smith R D (2014): Reef Life Survey: Global reef fish dataset. v2.0. Reef Life Survey. Dataset/Samplingevent. http://doi.org/10.15468/qjgwba"_ |