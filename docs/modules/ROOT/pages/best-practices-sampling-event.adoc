...
You may also refer to the following xref:sampling-event-data#_q_how_do_i_publish_a_hierarchy_of_events_recursive_data_type_using_parentEventID[FAQ].

=== How to capture absence data

Refer to the following xref:sampling-event-data#_q_how_do_i_publish_absence_data[FAQ].
...
xref:best-practices-sampling-event-planned-additions[]
